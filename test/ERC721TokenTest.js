...
contract.skip("ERC721Token", accounts => {
  ...
  describe("can transfer token", () => {
    ...
    beforeEach(async function() {
      ...
      tx = await this.contract.transferFrom(user1, user2, tokenId, {
        from: user1
      });
    });
    ...
    it("only permissioned users can transfer tokens", async function() {
      ...
      await expectThrow(
        this.contract.transferFrom(
          user1,
          randomPersonTryingToStealTokens,
          tokenId,
  ...
  describe("can set an operator", () => {
    ...
    beforeEach(async function() {
      ...
      tx = await this.contract.setApprovalForAll(operator, true, {
        from: user1
      });
    });
